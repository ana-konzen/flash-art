!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], e)
    : e(((t = "undefined" != typeof globalThis ? globalThis : t || self).brush = {}));
})(this, function (t) {
  "use strict";
  function e(t, e) {
    let s = new i(t),
  ...
  function h(t = !1) {
    let e = !(!o || !t) && a;
    n && l(!1), !t && o && (t = a), (s = t || window.self), y.load(e), (r = !0);
  }
  function l(t = !0) {
    n &&
      (y.masks[0].remove(),
  ...
  function c() {
    n || (r || h(), z.create(), b(s.width / 250), (n = !0));
  }
  let m = new e(Math.random());
  const d = {
    random(t = 0, e = 1) {
      return 1 === arguments.length ? this.map(m(), 0, 1, 0, t) : this.map(m(), 0, 1, t, e);
    },
    randInt(t, e) {
    ...
    map(t, e, i, s, n, r = !1) {
      let o = s + ((t - e) / (i - e)) * (n - s);
      return r ? (s < n ? this.constrain(o, s, n) : this.constrain(o, n, s)) : o;
    },
  ...
  const v = {
    ...
    trans() {
      return (
        (this.translation = [s._renderer.uMVMatrix.mat4[12], s._renderer.uMVMatrix.mat4[13]]),
        this.translation
      );
    },
  };
  ...
  const y = {
    ...
    load(t) {
      (this.type = o && !t ? 0 : t ? 2 : 1), (this.masks = []);
      for (let e = 0; e < 3; e++)
        switch (this.type) {
          case 0:
      ...
      for (let t of this.masks)
        t.pixelDensity(s.pixelDensity()), t.clear(), t.angleMode(s.DEGREES), t.noSmooth();
    ...
    blend(t = !1, e = !1, i = !1) {
      ...
      if (
        (t ? this.getPigment(t) : this.currentColor).toString() !== this.currentColor.toString() ||
        e ||
        !this.isCaching
      ) {
        if ((w(), this.isBlending)) {
          s.push(),
            ...
            this.shader.setUniform("random", [d.random(), d.random(), d.random()]);
        ...
        e ||
          ((this.currentColor = this.getPigment(t)),
          i ? (this.color1 = this.currentColor) : (this.color2 = this.currentColor));
      }
      e &&
        ((this.isBlending = !1), i ? (this.blending1 = this.isBlending) : (this.blending2 = this.isBlending));
    },
    ...
    addStandard() {
      _("curved", function (t, e) {
          ...
          for (let t = 0; t < z.num_columns; t++)
            for (let r = 0; r < z.num_rows; r++) {
              let o = s.noise(0.02 * t, 0.02 * r),
                a = Math.round(d.map(o, 0, 1, -i, i) / n) * n;
              e[t][r] = 4 * a;
            }
          return e;
        }),
        ...
        _("waves", function (t, e) {
          ...
          for (let t = 0; t < z.num_columns; t++)
            for (let r = 0; r < z.num_rows; r++) {
              let o = d.sin(i * t) * (n * d.cos(r * s)) + d.randInt(-3, 3);
              e[t][r] = o;
            }
          return e;
        }),
  ...
  class A {
    ...
    moveTo(t, e, i = M.spacing(), s = !0) {
      if (this.isIn()) {
        let n, r;
        s || ((n = d.cos(-e)), (r = d.sin(-e)));
        for (let o = 0; o < t / i; o++) {
          if (s) {
            let t = this.angle();
            (n = d.cos(t - e)), (r = d.sin(t - e));
          }
          let t = i * n,
            o = i * r;
  ...
  const M = {
    ...
    spacing() {
      return (
        ...
        "default" === this.p.type || "spray" === this.p.type ? this.p.spacing / this.w : this.p.spacing
      );
    },
    ...
    draw(t, e) {
      ...
      for (let n = 0; n < s; n++)
        this.tip(), e ? this.position.plotTo(this.plot, i, i, t) : this.position.moveTo(i, t, i, this.flow);
      this.popState();
    },
    drawTip(t) {
    ...
    pushState(t = !1) {
      if (((this.p = this.list.get(this.name).param), !t)) {
        (this.a = "custom" !== this.p.pressure.type ? d.random(-1, 1) : 0),
          ...
          (this.cp = "custom" !== this.p.pressure.type ? d.random(3, 3.5) : d.random(-0.2, 0.2));
        const [t, e] = this.p.pressure.min_max;
        (this.min = t), (this.max = e);
      }
      (this.c = s.color(this.c)),
        (this.mask = this.p.blend ? ("image" === this.p.type ? y.masks[1] : y.masks[0]) : y.masks[2]),
        v.trans(),
        this.mask.push(),
        this.mask.noStroke(),
        "image" === this.p.type
          ? this.mask.translate(v.translation[0], v.translation[1])
          : this.mask.translate(v.translation[0] + s.width / 2, v.translation[1] + s.height / 2),
    ...
    gauss(
      t = 0.5 + M.p.pressure.curve[0] * M.a,
      e = 1 - M.p.pressure.curve[1] * M.b,
      i = M.cp,
      s = M.min,
      n = M.max
    ) {
      return d.map(
        1 /
          (1 +
            Math.pow(Math.abs((this.position.plotted - t * this.length) / ((e * this.length) / 2)), 2 * i)),
        0,
        1,
        s,
        n
    ...
    isInsideClippingArea() {
      if (M.cr)
        return (
          this.position.x >= M.cr[0] &&
          this.position.x <= M.cr[2] &&
          this.position.y >= M.cr[1] &&
          this.position.y <= M.cr[3]
        );
      {
        let t = 0.55 * s.width,
          e = 0.55 * s.height;
    ...
    drawSpray(t) {
      let e = this.w * this.p.vibration * t + (this.w * d.gaussian() * this.p.vibration) / 3,
    ...
    drawDefault(t) {
      let e =
        ...
        this.p.vibration *
        (this.p.definition +
          ((1 - this.p.definition) * d.gaussian() * this.gauss(0.5, 0.9, 5, 0.2, 1.2)) / t);
      ...
      if (
        ...
        "image" === this.p.type &&
          (this.p.blend
            ...
            : this.mask.tint(this.mask.red(this.c), this.mask.green(this.c), this.mask.blue(this.c), e)),
    ...
    markerTip() {
      if (this.isInsideClippingArea()) {
        ...
        if ((this.mask.fill(255, 0, 0, e / 1.5), "marker" === M.p.type))
          for (let e = 1; e < 5; e++) this.drawMarker((t * e) / 5, !1);
        else if ("custom" === M.p.type || "image" === M.p.type)
          for (let i = 1; i < 5; i++) this.drawCustomOrImage((t * i) / 5, e, !1);
      }
    },
  };
  function S(t, e) {
    ...
    i || "spray" === e.type || (e.type = "default"),
      "image" === e.type &&
        (B.add(e.image.src),
        (e.tip = () =>
          M.mask.image(B.tips.get(M.p.image.src), -M.p.weight / 2, -M.p.weight / 2, M.p.weight, M.p.weight))),
      (e.blend = !!((i && !1 !== e.blend) || e.blend)),
      M.list.set(t, { param: e, colors: [], buffers: [] });
  }
  function P(t, e, i = 1) {
  ...
  const B = {
    ...
    load() {
      for (let t of this.tips.keys()) {
        let e = (o ? a : window.self).loadImage(t, () => B.imageToWhite(e));
        this.tips.set(t, e);
      }
    },
  };
  ...
  const F = {
      ...
      hatch(t) {
        let e = F.hatchingParams[0],
          ...
          o = M.w,
          a = M.isActive;
        F.hatchingBrush && P(F.hatchingBrush[0], F.hatchingBrush[1], F.hatchingBrush[2]),
          (i = d.toDegrees(i) % 180);
        let h = 1 / 0,
          l = -1 / 0,
          c = 1 / 0,
        ...
        let p = new R([
          ...
          y = e,
          w = (t) => ({
            point1: { x: h + y * t * d.cos(90 - i), y: f + y * t * d.sin(90 - i) },
            point2: { x: h + y * t * d.cos(90 - i) + d.cos(-i), y: f + y * t * d.sin(90 - i) + d.sin(-i) },
          });
        ...
        for (let t = 0; t < k.length; t++) {
          ...
          for (let s = 0; s < i.length - 1; s += 2)
            0 !== _ &&
              ...
              T(i[s].x, i[s].y, i[s + 1].x, i[s + 1].y),
              n && T(k[t - 1][1].x, k[t - 1][1].y, i[s].x, i[s].y);
        }
        P(r, n, o), (M.isActive = a);
      },
    },
    V = F.hatch;
  class R {
    constructor(t, e = !1) {
      (this.a = t),
        ...
        e && (this.vertices = t),
        (this.sides = this.vertices.map((t, e, i) => [t, i[(e + 1) % i.length]]));
    }
    intersect(t) {
    ...
    fill(t = !1, e, i, s, n, r) {
      let o = J.isActive;
      t && (U(t, e), K(i, r), $(s, n)), J.isActive && (c(), J.fill(this)), (J.isActive = o);
    }
    hatch(t = !1, e, i) {
      let s = F.isActive;
      ...
      for (let t = 0; t < o; t++) {
        ...
        (l += n),
          (l >= this.segments[t] * h * d.random(0.7, 1.3) || t >= m) &&
            a.x &&
            (r.push([a.x, a.y]), (l = 0), t >= m && m++);
      }
      return new R(r);
    }
    draw(t, e, i) {
      M.isActive &&
        (c(), this.origin && ((t = this.origin[0]), (e = this.origin[1]), (i = 1)), D(this, t, e, i));
    }
    fill(t, e, i) {
      J.isActive &&
        (c(),
        ...
        if (e > 0 && h < t.length - 2) {
          ...
          if (Math.floor(g) === Math.floor(x)) {
            ...
            let e = { x: c[0] - y * d.cos(-g), y: c[1] - y * d.sin(-g) },
              ...
              f = u(e, m, p, { x: p.x + w * d.cos(90 - x), y: p.y + w * d.sin(90 - x) }, !0),
      ...
      if (J.light_source)
        for (let t = 0; t < this.v.length; t++)
          d.dist(this.v[t].x, this.v[t].y, J.light_source.x, J.light_source.y) <
            d.dist(this.v[i].x, this.v[i].y, J.light_source.x, J.light_source.y) && (i = t);
  ...
  function Q(t, e, i, s, n) {
    let r = d.cos(n),
      o = d.sin(n);
    return { x: r * (i - t) + o * (s - e) + t, y: r * (s - e) - o * (i - t) + e };
  }
  class X {
    constructor(t, e, i, s, n = !1) {
      ...
      if (n)
        for (let t = 0; t < this.v.length; t++) {
          ...
          const o = (t, e, i) => (e.x - t.x) * (i.y - t.y) - (e.y - t.y) * (i.x - t.x) > 0.01;
          let a = 0;
          for (let t of J.polygon.intersect(r)) o(e, i, t) && a++;
          this.dir[t] = a % 2 == 0;
        }
    }
    trim(t) {
    ...
    grow(t, e = !1) {
      ...
      for (let e = 0; e < r.v.length; e++) {
        ...
        let c = 0.1 === t ? (J.bleed_strength <= 0.1 ? 0.25 : 0.75) : r.m[e];
    ...
    fill(t, e, i) {
      ...
      (y.watercolor = !0),
        ...
        y.masks[0].push(),
        y.masks[0].noStroke(),
        y.masks[0].translate(v.translation[0] + s.width / 2, v.translation[1] + s.height / 2),
      ...
      let m = this.grow(),
        ...
        f = this.grow(0.6);
      for (let t = 0; t < r; t++)
        (t !== Math.floor(r / 4) && t !== Math.floor(r / 2) && t !== Math.floor((3 * r) / 4)) ||
          ((m = m.grow()),
  ...
  (t.Plot = G),
    ...
    (t.circle = function (t, e, i, s = !1) {
      ...
      s && n.addSegment(0 + o, h * (Math.PI / 180) * i, !0), n.endPlot(h + o, 1, !0);
      let l = [t - i * d.sin(o), e - i * d.cos(-o)];
      n.show(l[0], l[1], 1);
    }),
    (t.clip = function (t) {
      M.cr = t;
    ...
    (t.pop = function () {
      (z.isActive = f.field.isActive),
        ...
        (M.isActive = f.stroke.isActive),
        (M.name = f.stroke.name),
        (M.c = f.stroke.color),
        (M.w = f.stroke.weight),
        (M.cr = f.stroke.clip),
    ...
    (t.push = function () {
      (f.field.isActive = z.isActive),
        ...
        (f.stroke.isActive = M.isActive),
        (f.stroke.name = M.name),
        (f.stroke.color = M.c),
        (f.stroke.weight = M.w),
        (f.stroke.clip = M.cr),
    ...
    (t.rect = function (t, e, i, n, r = s.CORNER) {
      if ((r == s.CENTER && ((t -= i / 2), (e -= n / 2)), z.isActive))
    ...
    (t.stroke = function (t, e, i) {
      arguments.length > 0 && (M.c = arguments.length < 2 ? t : [t, e, i]), (M.isActive = !0);
    }),
